...
# Recovered from https://learn.microsoft.com/en-us/azure/active-directory/enterprise-users/licensing-service-plan-reference on 06/02/2025
$LicenseTable = @{
...
$Licenses = Get-MgSubscribedSku | Where-Object{$_.AppliesTo -eq 'User' -and $_.CapabilityStatus -ne 'Suspended' -and $_.ConsumedUnits} | Select-Object SkuId,SkuPartNumber,@{L='DisplayName';E={$LicenseTable[$_.SkuPartNumber]}}
...
$Report = foreach($User in $Users){
    ...
    foreach($License in $Licenses){
        ...
        $Temp | Add-Member -NotePropertyName $License.DisplayName -NotePropertyValue $Test
    }
    $Temp
}
